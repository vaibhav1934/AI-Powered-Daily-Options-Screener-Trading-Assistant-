...
### 3. No Fallbacks, Predictions, or Heuristics
...
### 4. API-First Architecture & State Isolation
...
### 5. Automatic Documentation Alignment (`ARCHITECTURE_LLD.md`)
...
### 6. Mobile Compatibility & Responsive UI
