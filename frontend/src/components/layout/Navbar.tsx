...
import { Search, Bell, SlidersHorizontal, Sparkles, MessageSquare, BarChart2, Lock, LogOut, User as UserIcon } from "lucide-react";
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginLeft: "auto" }}>
          ...
          {authed ? (
            <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#f8f9fa", padding: "4px 12px", borderRadius: 20, border: "1px solid #e8eaed" }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "#202124" }}>{user?.username || "Trader"}</span>
              <button
            ...
            >
              <Lock size={13} /> Institutional Login
            </button>
          )}

          <Bell size={18} color="#5f6368" style={{ cursor: "pointer", marginLeft: 4 }} />
